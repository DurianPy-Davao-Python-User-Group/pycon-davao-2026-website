...
## 🎨 Visual & Responsive Validation

_Required for all UI/Frontend changes._
...
_Skip this section if no CMS API changes were made._
...
_Drag and drop screenshots/videos here:_

---

## 📋 Final Checklist

- [ ] **Sync**: Rebased from `main` and resolved any conflicts.
- [ ] **Build**: Project builds locally without errors (`npm run build`).
- [ ] **Visuals**: Attached mandatory visual evidence proving the UI works and matches design.
